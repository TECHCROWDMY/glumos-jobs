  ...
  return (
    <div
      className={`py-5 w-full h-[120px] bg-transparent fixed z-20 top-0 left-0 transition-all duration-300 ${
        isScrolled ? 'bg-[#fff] shadow-lg' : ''
      }`}
    >
      <div className="container h-full flex justify-between items-center px-5">
         {/* <h1 className='font-circularStdMedium text-2xl font-bold text-[#212121]'>HustleCrowd</h1> */}
         <img className="h-10 w-auto" src="https://cdn-images-1.medium.com/v2/resize:fit:1280/1*4Q6PIWw7n6bGpvEH7bDgkQ.png" alt="" />
{/* 
        <div className="hidden md:flex items-center font-circularStdMedium">
          <ul className="flex gap-8">
            <li><a href="/" className={activeMenu === 'Home' ? 'text-black' : 'text-gray-500'}>Home</a></li>
            <li><a href="/templates" className={activeMenu === 'Templates' ? 'text-black' : 'text-gray-500'}>Free templates</a></li>
            <li><a href="/about" className={activeMenu === 'About' ? 'text-black' : 'text-gray-500'}>About Us</a></li>
          </ul>
        </div> */}
...
//               Product
//               <ChevronDownIcon className="h-5 w-5 flex-none text-text-white" aria-hidden="true" />
//             </Popover.Button>
